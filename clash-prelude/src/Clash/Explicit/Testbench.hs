...
-- <BLANKLINE>
-- On cycle 0 of <RegularClock: System>, outputVerifier encountered an unexpected value:
--   Expected: 70
--   Actual:   0
-- [False
-- On cycle 1 of <RegularClock: System>, outputVerifier encountered an unexpected value:
--   Expected: 70
--   Actual:   0
-- ,False
-- On cycle 2 of <RegularClock: System>, outputVerifier encountered an unexpected value:
--   Expected: 99
--   Actual:   1
-- ,False,False,False,False,False
-- On cycle 7 of <RegularClock: System>, outputVerifier encountered an unexpected value:
--   Expected: 7
--   Actual:   6
-- ,False
-- On cycle 8 of <RegularClock: System>, outputVerifier encountered an unexpected value:
--   Expected: 8
--   Actual:   7
-- ,False
-- On cycle 9 of <RegularClock: System>, outputVerifier encountered an unexpected value:
--   Expected: 9
--   Actual:   8
-- ,False
-- On cycle 10 of <RegularClock: System>, outputVerifier encountered an unexpected value:
--   Expected: 10
--   Actual:   9
-- ,False,True]
--

...
meta-stability:
    ...
    *   /Clock situations 1, 2, and 3/:
        ...
        @
        k :: Clock tag -> Clock tag -> ..
        k x y = ..

        l :: Clock tag -> Clock tag -> ..
        l x y = ..

        m :: Clock tag -> Clock tag -> ..
        m x y = ..
        @
...
>>> :{
instance KnownDomain "Dom2" ('Domain "Dom2" 2 'Rising 'Asynchronous 'Defined 'ActiveHigh) where
  knownDomain = SDomain SSymbol SNat SRising SAsynchronous SDefined SActiveHigh
:}

>>> :{
instance KnownDomain "Dom7" ('Domain "Dom7" 7 'Rising 'Asynchronous 'Defined 'ActiveHigh) where
  knownDomain = SDomain SSymbol SNat SRising SAsynchronous SDefined SActiveHigh
:}
...
resetSynchronizer clk rst en =
  case knownDomain @tag of
    SDomain _tag _period _edge SAsynchronous _init _polarity ->
      let r1 = register clk rst en True (pure False)
          r2 = register clk rst en True r1
          r3 = bool (not <$> r2) r2 (isActiveHigh @tag)
       in unsafeToReset r3
    _ ->
...
--
-- @
-- instance KnownDomain "Dom7" ('Domain "Dom7" 2 'Rising 'Asynchronous 'Defined 'ActiveHigh) where
--   knownDomain = SDomain SSymbol SNat SRising SAsynchronous SDefined SActiveHigh
--
-- clk7 :: 'Clock' "Dom7"
-- clk7 = 'clockGen'
...
fastDelay clk i =
  delay
    clk
    (toEnable (pure True))
    (deepErrorX "First value of fastDelay undefined")
    i
{-# INLINE fastDelay #-}
